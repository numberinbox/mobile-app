...
extension AppColor on Color {
  static const primaryColor = Color(0xFF047857);
  static const primaryDarkColor = Color(0xFF0F172A);
  static const primaryLightColor = Color(0xFFFFFFFF);
  static const primarySelectedColor = Color(0xFFDDF7EC);
  ...
  static const textFieldFocusedBorderColor = Color(0xFF047857);
  ...
  static const loginTextFieldFocusedBorder = Color(0xFF047857);
  static const loginTextFieldHintColor = Color(0xff818C99);
  static const loginTextFieldBackgroundColor = Color(0xFFF2F3F5);
  static const appColor = Color(0xFF047857);
  static const nameUserColor = Color(0xFF0F172A);
  ...
  static const mailboxSelectedBackgroundColor = Color(0xFFDDF7EC);
  static const mailboxBackgroundColor = Color(0xFFFFFFFF);
  static const mailboxSelectedTextColor = Color(0xFF047857);
  static const mailboxTextColor = Color(0xFF0F172A);
  static const emailMailboxContainColor = Color(0xFF0F172A);
  static const mailboxSelectedTextNumberColor = Color(0xFF0F172A);
  static const mailboxSelectedIconColor = Color(0xFF047857);
  ...
  static const storageMaxSizeColor = Color(0xFF0F172A);
  static const storageUseSizeColor = Color(0xFF2D0CFF);
  static const myFolderTitleColor = Color(0xFF7E869B);
  static const titleAppBarMailboxListMail = Color(0xFF0F172A);
  static const counterMailboxColor = Color(0xFF047857);
  static const backgroundCounterMailboxColor = Color(0xFFDDF7EC);
  static const backgroundCounterMailboxSelectedColor = Color(0x17313131);
  static const bgMailboxListMail = Color(0xFFF5F7EB);
  static const bgMessenger = Color(0xFFF2F2F5);
  static const textButtonColor = Color(0xFF0F172A);
  static const attachmentFileBorderColor = Color(0x1F000000);
  static const attachmentFileNameColor = Color(0xFF0F172A);
  static const attachmentFileSizeColor = Color(0xFF818C99);
  static const avatarColor = Color(0xFFF8F8F8);
  static const avatarTextColor = Color(0xFF047857);
  static const sentTimeTextColorUnRead = Color(0xFF0F172A);
  static const subjectEmailTextColorUnRead = Color(0xFF047857);
  static const dividerColor = Color(0xFFEAEAEA);
  static const bgComposer = Color(0xFFF5F7EB);
  static const emailAddressChipColor = Color(0x0D001C3D);
  static const enableSendEmailButtonColor = Color(0xFF047857);
  ...
  static const colorNameEmail = Color(0xFF0F172A);
  static const colorContentEmail = Color(0xFF6D7885);
  static const colorTextButton = Color(0xFF047857);
  ...
  static const colorExpandMailbox = Color(0xFF047857);
  static const colorBgMailbox = Color(0xFFF7F7F7);
  static const colorFilterMessageDisabled = Color(0xFF99A2AD);
  static const colorFilterMessageEnabled = Color(0xFF047857);
  ...
  static const colorActionCancelDialog = Color(0xFF047857);
  ...
  static const colorItemEmailSelectedDesktop = Color(0xFFDDF7EC);
  ...
  static const colorShadowComposerButton = Color(0x99047857);
  ...
  static const colorItemRecipientSelected = Color(0xFFDDF7EC);
  ...
  static const colorSpamReportBannerBackground = Color(0xFFD9F2F5);
  ...
  static const colorSelected = Color(0xFFDDF7EC);
  static const colorAttachmentBorder = Color(0xFFE5ECF3);
  static const colorProgressLoadingBackground = Color(0xFFDDF7EC);
  static const colorDropZoneBackground = Color(0xFFF6FAFF);
  static const colorDropZoneBorder = Color(0xFF0369A1);
  ...
  static const colorComposeButton = Color(0xFF047857);
  static const steelGray400 = Color(0xFF818C99);
  static const steelGray600 = Color(0xFF4E5966);
  static const blue100 = Color(0xFFDDF7EC);
  static const blue400 = Color(0xFF6BC9D8);
  static const blue900 = Color(0xFF0369A1);
  ...
  static const m3SysLightSecondaryBlue = Color(0xFF06B6D4);
  ...
  static const m3SurfaceBackground = Color(0xFF0F172A);
  static const warningColor = Color(0xFFFFC107);
  static const primaryMain = Color(0xFF047857);
  ...
  static const iconFolder = Color(0xFF0369A1);
  static const folderDivider = Color(0xFFE4E8EC);
  static const gray424244 = Color(0xFF0F172A);
  ...
  static const textSecondary = Color(0xFF0F172A);
  ...
  static const primaryLinShare = Color(0xFF047857);
  ...
  static const m3Primary = Color(0xFF047857);
  static const m3Primary95 = Color(0xFFDDF7EC);
  static const gray49454F = Color(0xFF49454F);
  static const blue00B7FF = Color(0xFF06B6D4);
  static const blueD2E9FF = Color(0xFFD9F2F5);
  ...
  static const blue25AEFE = Color(0xFF06B6D4);
